...
$menu['menu300'] = array (
    ...
    */
    ...
    array('300200', '뉴스관리', G5_ADMIN_URL.'/board_news.php','',1),
    array('300300', '서포트', G5_ADMIN_URL.'/board_support.php','',1),
    array('300300', '이용약관&정책관리', G5_ADMIN_URL.'/board_agreement.php','',1),
    ...
    $menu['menu300'] = array (
        ...
        array('300300', '서포트(Support)', G5_ADMIN_URL.'/bbs/board.php?bo_table=support','',1),
        array('300300', '이용약관&정책관리', G5_ADMIN_URL.'/bbs/board.php?bo_table=agreement','',1), */
        array('300100', '공지사항관리(Notice)', G5_ADMIN_URL.'/board_notice.php','',1),
        array('300200', '뉴스관리', G5_ADMIN_URL.'/board_news.php','',1),
        array('300300', '서포트', G5_ADMIN_URL.'/board_support.php','',1),
        array('300300', '이용약관&정책관리', G5_ADMIN_URL.'/board_agreement.php','',1),
        array('300500', '팝업관리', ''.G5_ADMIN_URL.'/newwinlist.php', 'scf_poplayer',1)
    );
}
?>